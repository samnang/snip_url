defmodule SnipUrl.Shortner do
  @moduledoc """
  The boundary for the Shortner system.
  """
  ...
  defp url_changeset(%Url{} = url, attrs) do
    url
    |> cast(attrs, [:original_url, :snip_url])
    |> validate_required([:original_url, :snip_url])
  end
end
